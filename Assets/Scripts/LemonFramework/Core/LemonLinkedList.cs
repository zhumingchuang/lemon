...
namespace LemonFramework
{
    ...
    /// 链表类
    /// </summary>
    public class LemonLinkedList<T> : ICollection<T>, ICollection
    {
        ...
        public void RemoveFirst ()
        {
            ...
            if (first == null)
            {
                throw new LemonFrameworkException ("First is invalid.");
            }
        ...
        public void RemoveLast ()
        {
            ...
            if (last == null)
            {
                throw new LemonFrameworkException ("Last is invalid.");
            }
        ...
        public struct Enumerator : IEnumerator<T>
        {
            ...
            internal Enumerator (LinkedList<T> linkedList)
            {
                if (linkedList == null)
                {
                    throw new LemonFrameworkException ("Linked list is invalid.");
                }
